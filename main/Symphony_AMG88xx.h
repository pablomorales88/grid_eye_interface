#ifndef LIB_Symphony_AMG88XX_H
#define LIB_Symphony_AMG88XX_H
...
*/
/**************************************************************************/
class Symphony_AMG88xx {
public:
  // constructors
  Symphony_AMG88xx(void){};
  ~Symphony_AMG88xx(void);
  ...
  void readPixels(uint16_t *buf, uint8_t pixels = AMG88xx_PIXEL_ARRAY_SIZE);
...
private:
  Symphony_I2CDevice *i2c_dev = NULL; ///< Pointer to I2C bus interface
