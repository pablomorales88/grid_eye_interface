#include "Symphony_AMG88xx.h"

Symphony_AMG88xx::~Symphony_AMG88xx(void) {
  if (i2c_dev)
    delete i2c_dev;
}
...
*/
/**************************************************************************/
bool Symphony_AMG88xx::begin(uint8_t addr, TwoWire *theWire) {
  if (i2c_dev)
    delete i2c_dev;
  i2c_dev = new Symphony_I2CDevice(addr, theWire);
...
*/
/**************************************************************************/
void Symphony_AMG88xx::setMovingAverageMode(bool mode) {
  _ave.MAMOD = mode;
...
*/
/**************************************************************************/
void Symphony_AMG88xx::setInterruptLevels(float high, float low) {
...
*/
/**************************************************************************/
void Symphony_AMG88xx::enableInterrupt() {
  _intc.INTEN = 1;
...
*/
/**************************************************************************/
void Symphony_AMG88xx::disableInterrupt() {
  _intc.INTEN = 0;
  this->write8(AMG88xx_INTC, _intc.get());
}
...
*/
/**************************************************************************/
void Symphony_AMG88xx::setInterruptMode(uint8_t mode) {
  _intc.INTMOD = mode;
  this->write8(AMG88xx_INTC, _intc.get());
}
...
*/
/**************************************************************************/
void Symphony_AMG88xx::getInterrupt(uint8_t *buf, uint8_t size) {
...
*/
/**************************************************************************/
void Symphony_AMG88xx::clearInterrupt() {
...
*/
/**************************************************************************/
float Symphony_AMG88xx::readThermistor() {
  uint8_t raw[2];
...
*/
/**************************************************************************/
void Symphony_AMG88xx::readPixelsRaw(uint8_t *buf, uint8_t pixels) {
  uint8_t bytesToRead =
...
*/
/**************************************************************************/
// void Symphony_AMG88xx::readPixels(float *buf, uint8_t pixels) {
//   uint16_t recast;
//   float converted;
//   uint8_t bytesToRead =
//       min((uint8_t)(pixels << 1), (uint8_t)(AMG88xx_PIXEL_ARRAY_SIZE << 1));
...
void Symphony_AMG88xx::readPixels(uint16_t *buf, uint8_t pixels) {
  uint16_t recast;
  // float converted;
  uint8_t bytesToRead =
      min((uint8_t)(pixels << 1), (uint8_t)(AMG88xx_PIXEL_ARRAY_SIZE << 1));
...
*/
/**************************************************************************/
void Symphony_AMG88xx::write8(byte reg, byte value) {
...
*/
/**************************************************************************/
uint8_t Symphony_AMG88xx::read8(byte reg) {
  uint8_t ret;
  this->read(reg, &ret, 1);
...
void Symphony_AMG88xx::read(uint8_t reg, uint8_t *buf, uint8_t num) {
  uint8_t buffer[1] = {reg};
  i2c_dev->write_then_read(buffer, 1, buf, num);
}

void Symphony_AMG88xx::write(uint8_t reg, uint8_t *buf, uint8_t num) {
...
*/
/**************************************************************************/
float Symphony_AMG88xx::signedMag12ToFloat(uint16_t val) {
...
*/
/**************************************************************************/
float Symphony_AMG88xx::int12ToFloat(uint16_t val) {
  int16_t sVal =
